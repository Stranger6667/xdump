...
DEFAULT_PARAMETERS = [
    ...
    click.option(
        "-f",
        "--full",
        help="table name to be fully dumped. Could be used multiple times",
        multiple=True,
    ),
    click.option(
        "-p",
    ...
    click.option(
        "--schema/--no-schema",
        help="include / exclude the schema from the dump",
        default=True,
    ),
    click.option(
        "--data/--no-data",
        help="include / exclude the data from the dump",
        default=True,
    ),
] + COMMON_DECORATORS
...
def postgres(
    ...
    base_dump(
        "xdump.postgresql.PostgreSQLBackend",
        output,
        full,
        partial,
        compression,
